...
class getCatalinaData(object):
    # IMPORTANT NOTE: if the search radius captures two stars, both stars are included in the Catalina.csv file
    # I will deal with this issue, but if you just take Catalina.csv then it will have contaminents
    ...
    def handleData(RAdeg,Decdeg):
        ...
        np.savetxt('Catalina.dat', np.array([BJD,Mag,Magerr]).T)
